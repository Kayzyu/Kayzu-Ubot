...
PMPERMIT_PIC = os.environ.get(
    "PMPERMIT_PIC") or "https://telegra.ph/file/950d5fe4dd1dbe1726f5e.jpg"
...
ALIVE_LOGO = os.environ.get(
    "ALIVE_LOGO") or "https://telegra.ph/file/950d5fe4dd1dbe1726f5e.jpg"

# Default .helpme Logo
INLINE_PIC = os.environ.get(
    "INLINE_PIC") or "https://telegra.ph/file/950d5fe4dd1dbe1726f5e.jpg"
    ...
    try:
        ...
        main_help_button = [
            [
                ...
                Button.inline("ᴠᴄ ᴍᴇɴᴜ 📎", data="kay_inline"),
            ],
            [
        ...
        async def on_plug_in_callback_query_handler(event):
            if event.query.user_id == uid or event.query.user_id in SUDO_USERS:  # @Kay-Userbot
        ...
        @tgbot.on(events.CallbackQuery(data=b"kay_inline"))
...
""")
                await event.edit(
                    ...
                    file=kyylogo,
                    link_preview=True,
                    buttons=[Button.inline("ʙᴀᴄᴋ", data="kay_inline")])
            else:
                reply_pop_up_alert = f"❌ DISCLAIMER ❌\n\nAnda Tidak Mempunyai Hak Untuk Menekan Tombol Button Ini"
                await event.answer(reply_pop_up_alert, cache_time=0, alert=True)
